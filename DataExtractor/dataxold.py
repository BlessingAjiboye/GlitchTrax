...
class UsData_Clean(Base):
        ...
        def  __init__(self,cmplid,index,odino,mfrname,maketxt,modeltxt,yeartxt,crash,faildate,fire,injured,deaths,compdesc,city,state,country,zipcode,latitude,longitude,vin,datea,ldate,miles,occurences,cdescr,cmpltype,prodtype,airbagexpected,airbagdeployed,batchno):
            self.cmplid=cmplid
            self.index=index
            self.odino=odino
